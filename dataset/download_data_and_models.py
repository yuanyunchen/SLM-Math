...
Usage:
    ...
    python dataset/download_data_and_models.py --hf_token YOUR_TOKEN --datasets gsm8k math math500
    python dataset/download_data_and_models.py --hf_token YOUR_TOKEN --models Qwen2.5-Math-1.5B Qwen3-1.7B
"""
...
Examples:
  ...
  python dataset/download_data_and_models.py --hf_token YOUR_TOKEN --datasets gsm8k --models Qwen2.5-Math-1.5B
        """
    )
    ...
    base_path = script_path.parent.parent  # dataset/ -> project root
