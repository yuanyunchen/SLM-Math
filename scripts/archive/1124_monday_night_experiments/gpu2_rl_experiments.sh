...
# RL Config: 400 total steps, eval every 200 steps, save final only
################################################################################
...
RL_LOGGING_STEPS=10
RL_EVAL_STEPS=200
RL_SAVE_STEPS=200  # Only save at step 400 (final)
RL_TOTAL_STEPS=200
...
echo "Save steps: $RL_SAVE_STEPS (final only)"
...
LORA_BATCH_SIZE=24
LORA_GRAD_ACCUM=4
LORA_SAVE_EVERY=999  # Only save final
LORA_EVAL_EVERY=999  # Only eval at final
