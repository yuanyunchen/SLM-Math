...
################################################################################
# Experiment: Full SFT Training - Two Configurations
# GPU: 0
# Description: Full fine-tuning Qwen2.5-Math-1.5B with 5 epochs
...
ROUND_NAME_1="exp_sft_conservative"
...
ROUND_NAME_2="exp_sft_aggressive"
