...
################################################################################
# Test Solver-Checker-Summarizer Chat Workflow - 50 samples
...
echo "================================================================================"
echo "  Solver-Checker-Summarizer CHAT Test - 50 Samples"
echo "================================================================================"
echo ""
...
DETAILED="false"
CUDA_DEVICE=0
ROUND_NAME="scs_chat_v2_optimized"

echo "Configuration:"
echo "  Model: $MODEL"
echo "  Agent: solver_checker_summarizer_chat"
...
echo "================================================================================"
echo "Running solver_checker_summarizer_chat"
echo "================================================================================"
echo ""
...
if [ -n "$RESULT_DIR" ]; then
    ...
    if [ -f "$RESULT_DIR/analysis_report.txt" ]; then
        echo "Analysis Summary:"
        head -50 "$RESULT_DIR/analysis_report.txt"
        echo ""
    fi
fi
