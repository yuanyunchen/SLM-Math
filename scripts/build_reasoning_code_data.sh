...
################################################################################
# Reasoning + Code Data Generation (Multi-Model, Multi-Dataset)
#
# Generates reasoning + executable Python code for GSM8K train and MATH train.
# Two rounds:
#   - Round 1: teacher models with retries
#   - Round 2: expert models for remaining failures
...
# Output directory
OUTPUT_DIR="data/reasoning_code/run_$(date +%m%d_%H%M)"

echo "================================================================================"
echo "          Reasoning + Code Data Generation - Multi-Model Multi-Dataset"
echo "================================================================================"
echo ""
echo "Configuration:"
