...
################################################################################
# Plain LoRA Training (no chat template)
# Uses models/train_sft_plain.py with --mode lora
################################################################################
...
ROUND_NAME="plain_lora_full"

# Base model to train
MODEL="pretrained_models/Qwen2.5-Math-1.5B"

# Training data path (already boxed + correct only)
...
# Learning rate (plain LoRA; default in script would be 1e-4)
LEARNING_RATE=1e-4
...
echo "=========================================="
echo "Starting Plain LoRA Training (no chat template)"
echo "=========================================="
